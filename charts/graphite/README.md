...
[Graphite](https://graphiteapp.org/) is a monitoring tool. Forked from [Kiwigrid](https://github.com/kiwigrid)
...
- Has been tested on Kubernetes 1.26+
...
```bash
$ helm install iaacautomation/graphite --name graphite
```
...
| `image.tag`                    | Docker image                                 | `1.1.10-5`                             |
| `image.pullPolicy`             | Docker image pull policy                     | `IfNotPresent`                         |
| `service.type`                 | Service type                                 | `ClusterIP`                            |
| `service.port`                 | Service port of Graphite UI                  | `8080`                                 |
| `service.loadBalancerIP`       | loadBalancerIP if type Loadbalancer          | ``                                     |
...
```bash
$ helm install --name graphite --set ingress.enabled=false iaacautomation/graphite
```
